...
const researchItems = [
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Hooks 模式", link: "/research/best-practices/03-hooks-patterns" },
      { text: "Sub-agent、MCP、Skill", link: "/research/best-practices/04-subagent-mcp-skill" },
      ...
      { text: "Prompt Caching", link: "/research/best-practices/08-prompt-caching" },
      { text: "安全部署", link: "/research/best-practices/09-secure-deployment" },
      { text: "Agent Skills 企業版", link: "/research/best-practices/10-agent-skills-enterprise" },
      { text: "Routines", link: "/research/best-practices/11-routines" },
      { text: "Permissions", link: "/research/best-practices/12-permissions" },
      { text: "Sandbox", link: "/research/best-practices/13-sandbox" },
      { text: "MCP", link: "/research/best-practices/14-mcp" },
      { text: "Boris Cherny Tips", link: "/research/best-practices/15-boris-cherny-tips" },
      { text: "Thariq Tips", link: "/research/best-practices/16-thariq-tips" },
      ...
      { text: "功能總覽", link: "/research/best-practices/19-features-overview" },
      { text: "常見工作流", link: "/research/best-practices/20-common-workflows" },
      { text: "Memory 與 CLAUDE.md", link: "/research/best-practices/21-memory-claudemd" },
      { text: "Code Review", link: "/research/best-practices/22-code-review" },
      { text: "新功能 W13-W17", link: "/research/best-practices/23-whats-new-w13-w17" },
      { text: "Plugins", link: "/research/best-practices/24-plugins" },
      { text: "Boris Config & GitHub", link: "/research/best-practices/25-bcherny-config-github" },
      ...
      { text: "Thariq Prompt Caching", link: "/research/best-practices/28-thariq-prompt-caching-lessons" },
  ...
  },
  {
    ...
    items: [
      ...
      { text: "Auto-Load Token 優化", link: "/research/prompts/optimize-auto-load-tokens" },
