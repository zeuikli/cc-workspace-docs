...
- [Debug your configuration](https://code.claude.com/docs/en/debug-your-config) — 診斷 CLAUDE.md 或 settings 為何未生效
- [Skills](https://code.claude.com/docs/en/skills) — 打包按需載入的可重用 workflows
- [Settings](https://code.claude.com/docs/en/settings) — 用 settings files 設定 Claude Code 行為
- [Subagent memory](https://code.claude.com/docs/en/sub-agents#enable-persistent-memory) — 讓 subagents 維護自己的 auto memory
