...
## Post-26-May Additions（2026-05-29 更新）

本報告建議 2 個新 skill（iac-review 評分 2.6；diagram-gen 評分 2.2）於 2026-05-26–29 期間已落地，以下 5 個 skill 亦陸續新增：

| Skill | 新增日期 | 說明 |
|-------|---------|------|
| `iac-review` | 2026-05-26 | Terraform plan diff · K8s YAML security context · IaC drift（評分 2.6 ✅）|
| `diagram-gen` | 2026-05-26 | Mermaid / PlantUML 架構圖生成（評分 2.2 ✅）|
| `eval-designer` | 2026-05-27 | Evaluation function design · 4-condition validation |
| `token-waste-audit` | 2026-05-27 | Token 浪費診斷 · waste-diagnostic report |
| `autoload-evolution` | 2026-05-29 | Auto-load 規則閉環進化（Cycle 6 完成）|
| `gap-vote` | 2026-05-29 | Gap validation · consensus protocol |

**目前 skill 總數**：24 個（本報告發布時為 19 個；RESOLVER.md 已更新）。

評分矩陣未來應納入這些新 skill 以更新建議門檻。
