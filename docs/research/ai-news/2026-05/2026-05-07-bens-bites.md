...
Ben’s Bites is brought to you by [Attio](https://atlas.attio.com/?utm_source=bens_bites&utm_medium=newsletter&utm_campaign=bens_bites-Y26&utm_content=atlas)
...
You can now [use twice as much of Claude](https://www.anthropic.com/news/higher-limits-spacex) on all paid plans. How? Anthropic signed a deal to use all of SpaceX’s Colossus 1 data centre. (I guess no one needs/uses Grok)
