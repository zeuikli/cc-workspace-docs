...
</code></pre><p>---|---<br> \`</p><p>那什麼樣的硬體會從 MTP 拿到最大紅利？答案是<strong>記憶體頻寬 bound 的硬體</strong> 。</p><p>對照 PR 描述跟社群實測的加速倍率：</p><table tabindex="0"><thead><tr><th>硬體</th><th>加速倍率</th><th>為什麼</th></tr></thead><tbody><tr><td><strong>DGX Spark</strong> （273 GB/s 頻寬）</td><td><strong>2.57x</strong></td><td>頻寬最差 → 紅利最大</td></tr><tr><td><strong>RTX 3090</strong> （1008 GB/s 頻寬）</td><td><strong>1.71x</strong></td><td>頻寬充足 → 紅利縮水</td></tr><tr><td><strong>RTX 5090</strong> （1792 GB/s 頻寬）</td><td><strong>~1.87x</strong> （我自己實測）</td><td>頻寬最好 → 紅利再縮</td></tr></tbody></table><p><strong>規律很清楚：頻寬越緊張的硬體，MTP 加速越大。</strong></p><p>那 Mac Studio M3 Ultra 落在哪？<strong>819 GB/s</strong> 。比 DGX Spark 寬，但比 RTX 3090 緊。</p><p>更關鍵的是：<strong>Apple Silicon 統一記憶體架構本來就是「記憶體頻寬 bound」設計</strong> 。CPU、GPU、Neural Engine 共享同一條記憶體匯流排，這條匯流排是整個系統的天花板。</p><p>所以我的預期是：<strong>Mac Studio M3 Ultra 跑 Qwen3.6-27B 開 MTP，加速倍率會落在 2.0x ~ 2.4x 區間</strong> ，比 RTX 5090 上的 1.87x 更好。</p><p>如果這個預期成立，意思是：</p><ul><li>M3 Ultra 跑 Qwen3.6-27B 在沒 MTP 時大概 20-25 t/s（社群實測）</li><li>開 MTP 之後預期會到 <strong>45-55 t/s 單流</strong></li><li>這個速度對「一個工程師、一個 chat 框」的 interactive coding 場景<strong>完全夠用</strong></li></ul><p>對比 Sonnet 4.6 API 的 60-80 t/s streaming，Mac Studio 跟商業 API 的差距會縮到 1.5x 以內——而且沒有網路延遲、沒有 rate limit。</p><h2 id="誠實揭露-mac-還沒追上的部分" tabindex="-1">誠實揭露：Mac 還沒追上的部分 <a class="header-anchor" href="#誠實揭露-mac-還沒追上的部分" aria-label="Permalink to &quot;誠實揭露：Mac 還沒追上的部分&quot;">​</a></h2><p>寫到這裡得潑點冷水。Mac 用上 MTP 不代表追平 NVIDIA。</p><p><strong>1. Metal kernel 效率還是輸 CUDA kernel</strong> 即使有 MTP，底層的 attention / matmul kernel 在 Apple Silicon 上的實作通常比 CUDA 慢 20-40%。MTP 給的是「整體吞吐」的加速，不會修補 kernel 層的差距。</p><p><strong>2. MLX 還沒有 MTP</strong> Apple 自家的 MLX 框架到 2026 年 5 月為止還沒實作 MTP。如果你的 workflow 是 MLX-based（例如用 mlx-lm 寫研究 code），這個 PR 對你沒用，要等 MLX 團隊跟進。</p><p><strong>3. 並發場景 Mac 還是輸</strong> 跟 NVIDIA 卡一樣，llama.cpp + MTP 目前強制 <code>n_parallel=1</code>。如果你想用 Mac Studio 服務團隊（5-10 人同時用），這個 setup 不適合，要切回沒 MTP 的設定。但因為 vLLM 不支援 Mac，所以 Mac 在「並發 serving」這個場景<strong>沒有好答案</strong> 。</p><p><strong>4. 實測數字還沒大量出現</strong> PR 才 merge 一週多，Mac 用戶的實測 benchmark 還沒充分湧現。我前面講的「2.0x-2.4x 預期」是基於頻寬論證，不是實測。實際數字要再等幾週社群 benchmark 累積。</p><p><strong>5. M1 / M2 機器加速可能比 M3 / M4 小</strong> PR 用了一些新的 ggml 操作，這些操作在 M3 / M4 上有專門優化，M1 / M2 可能落到 fallback 路徑，加速幅度會縮水。</p><h2 id="對企業-it-架構師意味著什麼" tabindex="-1">對企業 IT 架構師意味著什麼 <a class="header-anchor" href="#對企業-it-架構師意味著什麼" aria-label="Permalink to &quot;對企業 IT 架構師意味著什麼&quot;">​</a></h2><p>這次解鎖最關鍵的影響是<strong>改寫了 Mac 在企業 AI 架構裡的角色</strong> 。</p><p>過去六個月，企業評估 on-prem AI Coding 的標準答案是：</p><ul><li>買 DGX Spark / RTX 5090 工作站</li><li>跑 Qwen3.6-27B / DeepSeek V3</li><li>跑 vLLM 服務多個工程師</li></ul><p>這個方案的問題是「<strong>多了一份硬體 + 多了一份運維</strong> 」。很多矽谷公司本來就配發 Mac Studio 或 MacBook Pro 給工程師——這些機器原本只是「終端」，不是「推理 server」。</p><p>PR #22673 改變了這個假設：</p><p><strong>配發給工程師的 Mac Studio M3 Ultra 256GB</strong> ，本身就是一台<strong>單人推理 server</strong> 。</p><ul><li>硬體扛得動 Qwen3.6-27B 不量化版本</li><li>軟體（llama.cpp + MTP）給出 enterprise tier 加速</li><li>速度預期 45-55 t/s，interactive coding 完全夠用</li><li>不用任何額外採購、不用 IT 部署 K8s</li></ul><p>這對 IT 架構的意義：</p><p><strong>1. on-prem AI Coding 的 TCO 重算</strong> 原本要算「採購 NVIDIA 工作站 + 運維」，現在可以走「公司本來就配的 Mac，多開一個推理 process」。TCO 直接砍掉硬體採購線。</p><p><strong>2. 資安合規場景多一個答案</strong> 金融 / 法律 / 醫療這些不能 call cloud API 的場景，過去的答案是「on-prem NVIDIA」，現在多了「員工自帶 Mac Studio 跑本地推理」這個選項。資料完全不離開員工那台機器。</p><p><strong>3. 不同團隊的工具策略可以分流</strong></p><ul><li><strong>研發團隊（個人工作流）</strong> ：MacBook Pro / Mac Studio + LM Studio + MTP → 個人單流</li><li><strong>平台團隊（共用服務）</strong> ：NVIDIA 工作站 + vLLM + AWQ + 並發 batching → 多用戶</li><li><strong>這兩條路不衝突，可以同時走</strong></li></ul><p>換個方式講：<strong>Mac 在 LLM 推理上從「次優選擇」升級成「特定場景的最佳選擇」</strong> ——特別是「一人一台、不需要共享、不能上雲」這類場景。</p><h2 id="常見問題-q-a-2" tabindex="-1">常見問題 Q&amp;A <a class="header-anchor" href="#常見問題-q-a-2" aria-label="Permalink to &quot;常見問題 Q&amp;A&quot;">​</a></h2><p><strong>Q: 我用 Mac mini M4 / MacBook Pro M3，這個更新有用嗎？</strong></p><p>有用，但效果取決於記憶體大小。M4 Mac mini（24GB / 32GB）能跑 Qwen3.6-27B Q4 量化版本（約 16GB），開 MTP 預期加速 1.8x-2.2x。MacBook Pro M3 Max（36GB / 64GB / 128GB）可以跑更大模型，加速幅度類似。</p><p><strong>Q: 我已經在用 LM Studio，需要做什麼？</strong></p><p>短期內不用做什麼。等 LM Studio 下一版升上 llama.cpp 的新 master（樂觀估計 1-2 個月內），更新後 MTP 會自動啟用。如果你想立刻試，可以直接編譯 llama.cpp master + 手動下 CLI。</p><p><strong>Q: MLX 跟 llama.cpp，Mac 用戶該選哪個？</strong></p><p>短期內如果重視速度，選 llama.cpp（有 MTP）。如果你的工作流是研究 / fine-tuning / 需要 PyTorch-like API，繼續用 MLX。中期看 MLX 會不會跟進 MTP——如果跟進了，MLX 在 Apple Silicon 上的 kernel 效率本來就比 llama.cpp 好，到時會反超。</p><p><strong>Q: Mac Studio M3 Ultra 跟 RTX 5090 該怎麼選？</strong></p><p>不是同個量級的決策。RTX 5090 適合「跑量化模型 + 並發 serving + 想用 vLLM 整套」；Mac Studio M3 Ultra 適合「跑大模型不量化 + 單人 interactive + 安靜省電」。如果你已經有 Mac，加 MTP 是免費升級；如果還沒買，看你的 workload 偏哪邊。</p><p><strong>Q: 為什麼說 MTP 是「enterprise tier」？</strong></p><p>因為過去這項技術只在 vLLM / SGLang / TensorRT-LLM 這些企業推理棧裡可用——換句話說，要享受 MTP 的人要有 CUDA 卡、要會起 Python server、要懂 deployment。家用 GGUF 路線（llama.cpp / Ollama / LM Studio）的使用者完全用不到。PR #22673 把這個技術從 enterprise tier 下放到家用 tier，而 Mac 是這次下放的最大受益者——因為 Mac 連 enterprise tier 都進不去。</p><hr><h2 id="結語" tabindex="-1">結語 <a class="header-anchor" href="#結語" aria-label="Permalink to &quot;結語&quot;">​</a></h2><p>PR #22673 對大多數人來說是「llama.cpp 又更新一個 feature」，但對 Mac 用戶來說是<strong>整整 16 個月的等待結束</strong> ——第一次能用上跟 H100 推理伺服器同等級的加速技術。</p><p>更有意思的是，從頻寬論證來看，Mac 拿到的紅利可能比 NVIDIA 消費卡還大。</p><p>我接下來會在我朋友的 Mac Studio M3 Ultra 256GB 上實測 Qwen3.6-27B 開 MTP 前後的數字，搭配前面 <a href="https://ai-coding.wiselychen.com/qwen-3-6-27b-rtx-5090-inference-engine-benchmark/" target="_blank" rel="noreferrer">RTX 5090 跑出 140 tok/s 的 benchmark</a> 做完整對照。預期會看到 Mac 的相對加速幅度大過 RTX 5090——但具體數字要實測才算。</p><p>數據出來再分享。</p><hr><p><strong>相關文章：</strong></p><ul><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/" target="_blank" rel="noreferrer">llama.cpp 終於合併 MTP：你的 DeepSeek / Qwen3.6 一直少跑了 30-60% 的速度</a></li><li><a href="https://ai-coding.wiselychen.com/qwen-3-6-27b-rtx-5090-inference-engine-benchmark/" target="_blank" rel="noreferrer">Qwen 3.6-27B 在 RTX 5090 上的 inference engine benchmark</a></li><li><a href="https://ai-coding.wiselychen.com/qwen-3-6-27b-gb10-home-inference-sonnet-level/" target="_blank" rel="noreferrer">Qwen 3.6-27B 在 DGX Spark 跑出 Sonnet 4.6 等級</a></li></ul><p><strong>參考資料：</strong></p><ul><li><a href="https://github.com/ggml-org/llama.cpp/pull/22673" target="_blank" rel="noreferrer">llama.cpp PR #22673: llama + spec: MTP Support</a></li><li><a href="https://docs.vllm.ai/en/latest/features/speculative_decoding/mtp/" target="_blank" rel="noreferrer">vLLM Speculative Decoding docs (MTP)</a></li><li><a href="https://www.reddit.com/r/LocalLLaMA/comments/1teqnf2/thats_a_good_news/" target="_blank" rel="noreferrer">Reddit: r/LocalLLaMA “That’s a good news…”</a></li></ul><hr><h2 id="llama-cpp-終於合併-mtp-你的-deepseek-qwen3-6-一直少跑了-30-60-的速度" tabindex="-1"><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/" target="_blank" rel="noreferrer">llama.cpp 終於合併 MTP：你的 DeepSeek / Qwen3.6 一直少跑了 30-60% 的速度</a> <a class="header-anchor" href="#llama-cpp-終於合併-mtp-你的-deepseek-qwen3-6-一直少跑了-30-60-的速度" aria-label="Permalink to &quot;[llama.cpp 終於合併 MTP：你的 DeepSeek / Qwen3.6 一直少跑了 30-60% 的速度](https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/)&quot;">​</a></h2><p><em>🏢 Wisely Chen AI | 2026-05-20</em></p><h2 id="目錄-2" tabindex="-1">目錄 <a class="header-anchor" href="#目錄-2" aria-label="Permalink to &quot;目錄&quot;">​</a></h2><ul><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#tldr" target="_blank" rel="noreferrer">TL;DR</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E9%82%A3%E5%89%87-776-%E8%AE%9A%E7%9A%84-reddit-%E6%88%AA%E5%9C%96%E6%85%B6%E7%A5%9D%E7%9A%84%E6%98%AF%E4%BB%80%E9%BA%BC" target="_blank" rel="noreferrer">那則 776 讚的 Reddit 截圖，慶祝的是什麼</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#mtp-%E5%88%B0%E5%BA%95%E6%98%AF%E4%BB%80%E9%BA%BC%E4%B8%80%E5%8F%A5%E8%A9%B1%E7%89%88%E6%9C%AC" target="_blank" rel="noreferrer">MTP 到底是什麼？一句話版本</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E4%B8%89%E7%B5%84%E7%A1%AC%E9%AB%94%E5%AF%A6%E6%B8%AC25x171x74" target="_blank" rel="noreferrer">三組硬體實測：2.5x、1.71x、74%</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E7%82%BA%E4%BB%80%E9%BA%BC%E9%80%9F%E5%BA%A6%E6%B2%92%E6%9C%89%E7%BF%BB%E4%B8%89%E5%80%8D72-%E7%9A%84%E6%8E%A5%E5%8F%97%E7%8E%87" target="_blank" rel="noreferrer">為什麼速度沒有翻三倍：72% 的接受率</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E5%8F%8D%E7%9B%B4%E8%A6%BA%E6%B4%9E%E5%AF%9F%E4%BD%A0%E7%9A%84-gguf-%E4%B8%80%E7%9B%B4%E8%B7%91%E5%8D%8A%E9%80%9F" target="_blank" rel="noreferrer">反直覺洞察：你的 GGUF 一直跑半速</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E8%AA%A0%E5%AF%A6%E6%8F%AD%E9%9C%B2mtp-%E4%B8%8D%E6%98%AF%E5%85%8D%E8%B2%BB%E5%8D%88%E9%A4%90" target="_blank" rel="noreferrer">誠實揭露：MTP 不是免費午餐</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E6%9C%80%E5%A4%A7%E5%8F%97%E7%9B%8A%E8%80%85%E5%85%B6%E5%AF%A6%E4%B8%8D%E6%98%AF-nvidia-%E7%94%A8%E6%88%B6%E6%98%AF-mac" target="_blank" rel="noreferrer">最大受益者其實不是 NVIDIA 用戶——是 Mac</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E5%B0%8D%E4%BC%81%E6%A5%AD-on-prem-%E6%9E%B6%E6%A7%8B%E5%B8%AB%E6%84%8F%E5%91%B3%E8%91%97%E4%BB%80%E9%BA%BC" target="_blank" rel="noreferrer">對企業 on-prem 架構師意味著什麼</a></li><li><a href="https://ai-coding.wiselychen.com/llama-cpp-mtp-merged-local-llm-2x-speedup/#%E5%B8%B8%E8%A6%8B%E5%95%8F%E9%A1%8C-qa" target="_blank" rel="noreferrer">常見問題 Q&amp;A</a></li></ul><h2 id="tl-dr-2" tabindex="-1">TL;DR <a class="header-anchor" href="#tl-dr-2" aria-label="Permalink to &quot;TL;DR&quot;">​</a></h2><ul><li><strong>2026-05-16，llama.cpp PR #22673 合併</strong> ，原生支援 Multi-Token Prediction（MTP）speculative decoding</li><li>社群實測：DGX Spark 跑 Qwen3.6-27B <strong>7.0 → 18.0 tok/s，2.57x</strong> ；RTX 3090 <strong>38.86 → 65 tok/s，1.71x</strong></li><li><strong>我自己在 RTX 5090 上實測 Qwen3.6-27B + MTP 拿到 140 tok/sec 單流、70%+ acceptance rate</strong> ，跟 PR 描述的 72.18% 幾乎重疊</li><li><strong>這次 PR 真正的最大受益者其實是 Mac 用戶</strong> ——vLLM / SGLang / TensorRT-LLM 永遠不會支援 Apple Silicon，Mac 用戶過去 16 個月想用 MTP「沒有任何一條路」。詳見另一篇 <a href="https://ai-coding.wiselychen.com/mac-first-enterprise-inference-stack-mtp/" target="_blank" rel="noreferrer">Mac 用戶等了 16 個月：第一次能用「企業級」LLM 推理加速</a></li><li>不是「新模型」新聞，是「inference 框架終於追上模型架構」的新聞——DeepSeek-V3 從 2024 年底就有 MTP heads，<strong>本地用戶等了快一年才能真正按下這個按鈕</strong></li><li>限制：只對「訓練時就帶 MTP head」的模型有效（DeepSeek-V3/R1、Qwen3.6 系列），而且目前 <code>n_parallel=1</code>，多用戶場景 vLLM + AWQ 還是壓倒性勝利</li></ul><hr><h2 id="那則-776-讚的-reddit-截圖-慶祝的是什麼" tabindex="-1">那則 776 讚的 Reddit 截圖，慶祝的是什麼 <a class="header-anchor" href="#那則-776-讚的-reddit-截圖-慶祝的是什麼" aria-label="Permalink to &quot;那則 776 讚的 Reddit 截圖，慶祝的是什麼&quot;">​</a></h2><p>事情是這樣的。</p><p>5 月 16 日，r/LocalLLaMA 上有人貼了一張 PR 已 merge 的截圖，標題寫 “That’s a good news…“，內文只有兩句話：</p><blockquote><p>“Looks like it finally happens… MTP getting approved for llama.cpp. Time to prepare for the update.”</p></blockquote><p>兩天內 776 upvotes、242 條留言。對一個技術 PR merge 的反應來說，這個熱度是不太尋常的。</p><p>但你要理解為什麼大家這麼激動，得先回到 2024 年底——DeepSeek-V3 release 的那一刻，模型架構裡就已經內建了 MTP heads，官方論文宣稱可以拿到 <strong>1.8x</strong> TPS 加速。</p><p>問題是，這個能力<strong>只有 DeepSeek 自己的 inference 伺服器跟 SGLang / vLLM 用得起來</strong> 。本地用 llama.cpp 跑 GGUF 的人，等於拿了一台跑車但沒拿到鑰匙。</p><p>整整一年。</p><p>5 月 16 日，鑰匙終於發下來了。</p><h2 id="mtp-到底是什麼-一句話版本" tabindex="-1">MTP 到底是什麼？一句話版本 <a class="header-anchor" href="#mtp-到底是什麼-一句話版本" aria-label="Permalink to &quot;MTP 到底是什麼？一句話版本&quot;">​</a></h2><p><strong>MTP = 模型自己當自己的 draft model。</strong></p><p>過去要做 speculative decoding，你得跑「大模型 + 小模型」兩顆——小模型先猜幾個 token，大模型驗證。聽起來合理，但實務上很煩，因為你要為每個大模型找一顆「夠像但夠小」的搭檔。</p><p>MTP 的做法是：訓練時就在大模型裡多裝幾個 prediction head，讓它一次 forward pass 就能吐出「下一個 token + 接下來幾個草稿 token」。然後主模型自己驗證自己的草稿。</p><p>對使用者來說，這意味著：</p><ul><li>不用找 draft model</li><li>不用多載一份 KV cache（雖然實作上 MTP head 還是有自己的 context）</li><li>接受率比外掛 draft model 高很多，因為這些草稿頭是「同一個模型自己的延伸」</li></ul><p>llama.cpp 的開法很簡單：</p><pre><code>1
</code></pre><p>|</p><pre><code>--spec-type mtp --spec-draft-n-max 3
</code></pre><p>---|---<br> \`</p><p>第二個參數是草稿幾個 token，社群目前測下來 <strong>3 是個甜蜜點</strong> 。</p><h2 id="三組硬體實測-2-5x、1-71x、74" tabindex="-1">三組硬體實測：2.5x、1.71x、74% <a class="header-anchor" href="#三組硬體實測-2-5x、1-71x、74" aria-label="Permalink to &quot;三組硬體實測：2.5x、1.71x、74%&quot;">​</a></h2><p>這是這次最有意思的部分——同一個 feature 在不同硬體上加速幅度差很大。</p><table tabindex="0"><thead><tr><th>硬體配置</th><th>模型</th><th>Baseline</th><th>MTP 開啟</th><th>加速倍率</th></tr></thead><tbody><tr><td><strong>DGX Spark</strong> （$4,699 家用 AI 工作站）</td><td>Qwen3.6-27B</td><td>7.0 tok/s</td><td>18.0 tok/s</td><td><strong>2.57x</strong></td></tr><tr><td><strong>RTX 3090</strong></td><td>Qwen3.6-27B</td><td>38.86 tok/s</td><td>65-67 tok/s</td><td><strong>1.71x</strong></td></tr><tr><td><strong>3x RTX 3060</strong> （社群實測）</td><td>Qwen3.6-27B</td><td>-</td><td>-</td><td><strong>+74%</strong></td></tr><tr><td><strong>SGLang + AMD MI300</strong> （DeepSeek-V3，非 llama.cpp）</td><td>-</td><td>-</td><td>-</td><td>1.25-2.11x（Random）/ 1.36-1.80x（ShareGPT）</td></tr></tbody></table><p>幾個觀察：</p><p><strong>第一，記憶體頻寬瓶頸越嚴重的機器，加速越誇張。</strong> DGX Spark 拿 2.57x 的原因是它本來就是頻寬瓶頸機（128GB 統一記憶體但頻寬不如 RTX 3090），MTP 等於把「同一次 memory access 多算幾個 token」的紅利吃滿。</p><p><strong>第二，RTX 3090 從 38 → 65 tok/s 不算誇張，但意義很大。</strong> 因為 27B 在消費卡上本來就接近實用門檻，1.71x 等於從「勉強用」變成「順順用」。</p><p><strong>第三，SGLang 跑 DeepSeek-V3 的 1.25-2.11x 區間揭露了一個重點：concurrency 越高，MTP 加速越小</strong> 。AMD 那邊測 1、2、4、8、16、32、64 user 的場景，倍率是遞減的——這也是為什麼 llama.cpp 目前的實作直接強制 <code>n_parallel=1</code>。</p><h2 id="為什麼速度沒有翻三倍-72-的接受率" tabindex="-1">為什麼速度沒有翻三倍：72% 的接受率 <a class="header-anchor" href="#為什麼速度沒有翻三倍-72-的接受率" aria-label="Permalink to &quot;為什麼速度沒有翻三倍：72% 的接受率&quot;">​</a></h2><p>PR 描述裡有一個關鍵數字：<strong>Aggregate acceptance rate 72.18%</strong> 。</p><p>意思是：模型每草稿 3 個 token，平均有 2.16 個會通過自己的驗證、被接受寫入輸出。剩下的 0.84 個被丟掉、重算。</p><p>這就是為什麼你看到的加速是 1.7x ~ 2.5x，不是 3x ~ 4x：</p><pre><code>1
2
3
4
5
</code></pre><p>|</p><pre><code>理論上限 = 1 + n_draft × acceptance_rate
        = 1 + 3 × 0.72
        = 3.16x（不含驗證 overhead）

實際 = 約 1.7x ~ 2.5x（含驗證跟 KV 寫入 overhead）
</code></pre><p>---|---<br> \`</p><p>接受率為什麼是 72% 不是 95%？因為 MTP head 雖然跟主模型同源，但它預測「未來 N 個 token」的時候只看到當下的 hidden state——本質上還是一個近似。</p><p>這也呼應到一個有意思的點：<strong>任務越「可預測」，加速越大</strong> 。寫 boilerplate code、補全 API call 這種 acceptance rate 會接近 80-85%；寫複雜推理或創意文字會掉到 60% 以下。</p><p>DataCamp 那篇 tutorial 實測就觀察到，跑 AIME 數學題的時候速度從 65 tok/s 掉回 56-61 tok/s——還是比 baseline 快，但加速幅度縮水。</p><h2 id="反直覺洞察-你的-gguf-一直跑半速" tabindex="-1">反直覺洞察：你的 GGUF 一直跑半速 <a class="header-anchor" href="#反直覺洞察-你的-gguf-一直跑半速" aria-label="Permalink to &quot;反直覺洞察：你的 GGUF 一直跑半速&quot;">​</a></h2><p>這篇文章真正想講的是這件事。</p><p>過去一年，本地 LLM 圈花很多時間在優化「能跑哪些模型」、「量化能壓多狠」、「kernel 能調多快」。所有這些優化都在原本的 single-token autoregressive 框架裡卷。</p><p>但事實是：<strong>DeepSeek-V3 / Qwen3.6 這幾顆主流開源大模型，從訓練的第一天就準備好了 multi-token 模式</strong> 。權重裡的 MTP heads 一直躺在你硬碟上，只是 llama.cpp 不知道怎麼讀。</p><p>換個說法：</p><ul><li>如果你 2025 年 1 月 download 了 DeepSeek-V3 GGUF 開始本地推理</li><li>到 2026 年 5 月 16 日為止，<strong>你大概率一直在跑半速</strong></li><li>不是你的硬體不夠，不是你 prompt 寫得不好，不是量化太狠</li><li>是 inference 框架沒實作這個功能</li></ul><p>這個 gap 大概有 16 個月。</p><p>對企業 IT 架構決策來說這件事的啟示是：<strong>模型架構的進度跟 inference 框架的進度，從來不是同步的</strong> 。當你算 on-prem AI Coding 的 ROI 時，你算的是「今天的軟體跑今天的硬體跑今天的模型」這個快照——但那個快照六個月後可能因為一個 PR merge 就翻一倍。</p><h3 id="把這件事接回我自己手上的數字" tabindex="-1">把這件事接回我自己手上的數字 <a class="header-anchor" href="#把這件事接回我自己手上的數字" aria-label="Permalink to &quot;把這件事接回我自己手上的數字&quot;">​</a></h3><p>這次 PR merge 對我有點不一樣，因為我<strong>已經在 RTX 5090 上實測過 MTP 了</strong> ——上一篇 <a href="https://ai-coding.wiselychen.com/qwen-3-6-27b-rtx-5090-inference-engine-benchmark/" target="_blank" rel="noreferrer">Qwen 3.6-27B 在 RTX 5090 上的 inference engine benchmark</a> 跑了 7 組配置，其中一組就是 llama.cpp + Q2_K_XL + MTP，結果如下：</p><table tabindex="0"><thead><tr><th>配置</th><th>單流（1 user）</th><th>並發（8 users）</th></tr></thead><tbody><tr><td>vLLM + AWQ-INT4 + cudagraph</td><td>80.5 tok/s</td><td><strong>575 tok/s</strong> ⭐</td></tr><tr><td><strong>llama.cpp + Q2_K_XL + MTP</strong></td><td><strong>140 tok/s</strong> ⭐</td><td>118 tok/s</td></tr><tr><td>llama.cpp + Q4_K_M（無 MTP）</td><td>75 tok/s</td><td>189 tok/s</td></tr><tr><td>Ollama + Q4_K_M</td><td>67 tok/s</td><td>64 tok/s</td></tr></tbody></table><p>幾個對照重點：</p><p><strong>第一，PR 描述的 acceptance rate 72%，我實測到 70%+</strong> ——兩個數字幾乎重疊，這驗證了 MTP head 的品質在不同硬體 / quant 設定下相當穩定，不是 cherry pick 出來的數字。</p><p><strong>第二，單流 140 tok/sec 跟同模型 llama.cpp Q4_K_M 無 MTP 的 75 tok/sec 對比，加速約 1.87x</strong> ——落在前面講的 1.7x-2.5x 區間，跟 PR 報的 RTX 3090 上 1.71x 接近。</p><p><strong>第三，並發場景的 trade-off 在這張表上一目了然</strong> ：</p><ul><li>vLLM 在 8 users 並發拉到 575 tok/s（continuous batching 的紅利）</li><li>但 llama.cpp + MTP 並發反而從 140 掉到 118 tok/s——這就是前面說的 <code>n_parallel=1</code> 限制具體長什麼樣</li></ul><p>換句話說：<strong>MTP 不是「一定贏」的優化</strong> 。如果你的場景是 single-stream interactive coding（工程師一個 session 對話），MTP 是免費午餐；如果是 batch inference / 多用戶 API server，vLLM + AWQ 還是壓倒性勝利。</p><p><strong>第四，140 tok/sec 單流是什麼概念？</strong> Sonnet 4.6 透過 API 拿到的 streaming 速度大概 60-80 tok/sec（看時段跟 region）。<strong>一張 RTX 5090（市價 $2,000 美金等級）跑 Qwen3.6-27B 開 MTP，單流速度直接是 Anthropic API 的 1.75 倍</strong> ——而且沒有網路 round-trip、沒有共用佇列、沒有 rate limit。</p><h2 id="誠實揭露-mtp-不是免費午餐" tabindex="-1">誠實揭露：MTP 不是免費午餐 <a class="header-anchor" href="#誠實揭露-mtp-不是免費午餐" aria-label="Permalink to &quot;誠實揭露：MTP 不是免費午餐&quot;">​</a></h2><p>寫到這裡得潑點冷水。</p><p><strong>1. 不是所有模型都能用</strong></p><p>只有「訓練時就帶 MTP heads」的模型才能開。目前確認支援的：</p><ul><li>DeepSeek-V3、DeepSeek-R1（包含 distill 版本）</li><li>Qwen3.6-27B、Qwen3.6-35BA3B</li></ul><p>Llama 3 系列、Mistral、Gemma 這些<strong>沒有 MTP head</strong> ，這個 PR 對它們沒用。你只能繼續走傳統 speculative decoding（找一顆 draft model）那條路。</p><p><strong>2. 目前 server 多用戶場景不能用</strong></p><p>PR merge 後的版本強制 <code>n_parallel=1</code>。如果你的 on-prem 架構是「一台機器服務十個工程師」，這個 feature 暫時還不適合你。社群在討論 batching 支援，但需要時間。</p><p><strong>3. Acceptance rate 變數很大</strong></p><p>前面講過，任務越創意 / 越長 reasoning，acceptance rate 掉得越凶。如果你的 workload 主要是長 reasoning chain（agentic coding 中後段、複雜數學），實際加速可能只有 1.3x ~ 1.5x。</p><p><strong>4. 多了 device-to-host embedding transfer overhead</strong></p><p>PR 描述裡明寫了，prompt processing 階段會多一份 embedding 傳輸成本。short prompt + long generation 場景拿到最大紅利，long prompt + short generation 場景紅利會被吃掉。</p><h2 id="最大受益者其實不是-nvidia-用戶——是-mac" tabindex="-1">最大受益者其實不是 NVIDIA 用戶——是 Mac <a class="header-anchor" href="#最大受益者其實不是-nvidia-用戶——是-mac" aria-label="Permalink to &quot;最大受益者其實不是 NVIDIA 用戶——是 Mac&quot;">​</a></h2><p>寫到這裡有一個視角必須補上，因為它跟「能拿到多少加速倍率」這個技術問題其實是分開的。</p><p>NVIDIA 用戶這次的故事是「<strong>從用 vLLM 麻煩變成用 llama.cpp 輕鬆</strong> 」——本來門就是開的，只是要走樓梯，現在多了一個電梯。</p><p>但 Mac 用戶的故事完全不一樣，是「<strong>從鎖死變成打開</strong> 」。</p><p>具體講：</p><table tabindex="0"><thead><tr><th>推理棧</th><th>NVIDIA 卡</th><th>Mac (Apple Silicon)</th></tr></thead><tbody><tr><td>vLLM + MTP</td><td>✅ 早就支援（2025 初）</td><td>❌ 完全跑不了（沒 CUDA）</td></tr><tr><td>SGLang + MTP</td><td>✅ 早就支援</td><td>❌ 完全跑不了</td></tr><tr><td>TensorRT-LLM + MTP</td><td>✅ NVIDIA 獨家</td><td>❌ 永遠不會支援</td></tr><tr><td><strong>llama.cpp + MTP（2026-05-16）</strong></td><td>✅ <strong>新解鎖</strong></td><td>✅ <strong>新解鎖</strong></td></tr></tbody></table><p>對 NVIDIA 用戶：MTP 在 2025 年初就能用了，只是要會起 vLLM。</p><p>對 Mac 用戶：<strong>過去 16 個月「沒有任何一條路」能用到 MTP</strong> ——llama.cpp 沒做、Ollama / LM Studio 跟在 llama.cpp 後面、MLX 也沒做、Apple 自己也沒做。</p><p>更有意思的是，從<strong>記憶體頻寬論證</strong> 來看，Mac Studio 拿到的 MTP 紅利應該<strong>大過 RTX 5090</strong> ——因為 MTP 的核心紅利是「同一次 memory access 算多個 token」，越是頻寬 bound 的硬體越受惠。Apple Silicon 統一記憶體架構天生就是頻寬 bound。</p><p>這個推論細節跟 Mac 視角的完整論證，我寫在另一篇：<a href="https://ai-coding.wiselychen.com/mac-first-enterprise-inference-stack-mtp/" target="_blank" rel="noreferrer">Mac 用戶等了 16 個月：第一次能用「企業級」LLM 推理加速</a>。</p><p>對 IT 架構師來說，這意味著一件具體的事：<strong>公司本來就配 Mac 給工程師的，Mac Studio M3 Ultra 256GB 本身就可以變成一台單人推理 server</strong> ——不用再買 NVIDIA 工作站。</p><h2 id="對企業-on-prem-架構師意味著什麼" tabindex="-1">對企業 on-prem 架構師意味著什麼 <a class="header-anchor" href="#對企業-on-prem-架構師意味著什麼" aria-label="Permalink to &quot;對企業 on-prem 架構師意味著什麼&quot;">​</a></h2><p>我們團隊在做企業 on-prem AI Coding 評估的時候，這次 PR merge 大概會改變三件事：</p><p><strong>1. 重新算成本模型</strong></p><p>如果你的 on-prem 架構評估是 6 個月前做的，數字幾乎肯定過時。一台跑 Qwen3.6-27B 的機器，throughput 帳面上要加 1.7x ~ 2.5x。這個倍率落到每月帳上會很可觀。</p><p><strong>2. 重新看模型選型</strong></p><p>過去選 Llama 3 系列或 Mistral 的，現在要回頭看 DeepSeek / Qwen3.6——不只是因為 benchmark 數字，是因為它們<strong>架構上就比較適合本地推理</strong> 。MTP heads 是這個差距的具體表現。</p><p><strong>3. 重新評估 inference 框架的 release cadence</strong></p><p>llama.cpp 不是慢，是它要支援的硬體 / OS / 模型架構組合太多。如果你的公司在押本地推理，要把「inference 框架的 feature roadmap」當成跟模型 release 同等重要的觀察對象——這次的 MTP 是一個例子，下次可能是某個新的 attention kernel。</p><p>換個方式講：<strong>選 on-prem 不只是選模型，是選一個三條時間線的交集</strong> ——模型 release、inference 框架 feature、硬體更新。任何一條突進，整個 ROI 公式都要重算。</p><h2 id="常見問題-q-a-3" tabindex="-1">常見問題 Q&amp;A <a class="header-anchor" href="#常見問題-q-a-3" aria-label="Permalink to &quot;常見問題 Q&amp;A&quot;">​</a></h2><p><strong>Q: 我用 Ollama / LM Studio，要怎麼用到這個？</strong></p><p>短期內還用不到。Ollama 跟 LM Studio 都基於 llama.cpp，但有自己的 release cadence。樂觀估計 1-2 個月後會跟進，但你要等他們的版本 bump，不會 PR merge 隔天就有。</p><p><strong>Q: 一定要重新下載模型嗎？</strong></p><p>不用。GGUF 檔本身已經包含 MTP heads（如果模型訓練時有的話），llama.cpp 之前只是不知道怎麼讀那個 tensor。升級 binary 就好。</p><p><strong>Q: 對 MoE 模型（Qwen3.6-35BA3B）效果如何？</strong></p><p>社群測下來加速幅度跟 dense model 接近。MTP 跟 MoE 是兩個正交的優化——MTP 是「一次預測多個 token」，MoE 是「每個 token 只激活部分專家」，兩個疊起來用沒問題。</p><p><strong>Q: 我可以用 MTP 訓練我自己的小模型嗎？</strong></p><p>可以，但這是 pretraining 階段就要決定的——MTP heads 是模型結構的一部分。你沒辦法在訓練完後「加裝」MTP 進去（雖然有些 paper 在嘗試 self-distillation 做法，例如 arxiv 2509.18362 的 FastMTP）。</p><p><strong>Q: 這跟 EAGLE / Medusa 那些 speculative decoding 框架是什麼關係？</strong></p><p>概念上接近——都是「不要外掛 draft model，用模型自己預測多 token」。差別是 EAGLE / Medusa 是「post-hoc 加裝」，MTP 是「pretraining 內建」。內建的版本架構整潔、品質穩定，但你得在訓練時就決定。</p><hr><h2 id="結語-1" tabindex="-1">結語 <a class="header-anchor" href="#結語-1" aria-label="Permalink to &quot;結語&quot;">​</a></h2><p>776 個 upvotes 慶祝的不是一個新功能，是一段被閒置一年的算力終於可以用了。</p><p>對技術人來說這是好消息，對企業架構師來說這是提醒——你 6 個月前算的 ROI 假設，可能因為一個 PR merge 就要全部重算。</p><p>我之前在 <a href="https://ai-coding.wiselychen.com/qwen-3-6-27b-rtx-5090-inference-engine-benchmark/" target="_blank" rel="noreferrer">RTX 5090 上跑 Qwen3.6-27B + MTP 已經拿到 140 tok/sec 單流</a>，acceptance rate 70%+，跟這次官方 PR 描述的 72.18% 幾乎吻合。</p><p>接下來會做的是<strong>並發場景的深度測試</strong> ——MTP 在 single-stream 已經贏了，但在企業多用戶情境下到底要不要切回 vLLM + AWQ，這條決策曲線值得畫清楚。數據出來再分享。</p><hr><p><strong>參考資料：</strong></p><ul><li><a href="https://www.reddit.com/r/LocalLLaMA/comments/1teqnf2/thats_a_good_news/" target="_blank" rel="noreferrer">Reddit: r/LocalLLaMA “That’s a good news…”</a></li><li><a href="https://github.com/ggml-org/llama.cpp/pull/22673" target="_blank" rel="noreferrer">llama.cpp PR #22673: llama + spec: MTP Support</a></li><li><a href="https://www.datacamp.com/tutorial/multi-token-prediction-llama-cpp" target="_blank" rel="noreferrer">DataCamp: Multi-Token Prediction Tutorial with llama.cpp</a></li><li><a href="https://rocm.blogs.amd.com/software-tools-optimization/mtp/README.html" target="_blank" rel="noreferrer">AMD ROCm Blog: Efficient LLM Serving with MTP — DeepSeek V3 and SGLang</a></li><li><a href="https://arxiv.org/pdf/2509.18362" target="_blank" rel="noreferrer">FastMTP: Accelerating LLM Inference with Enhanced Multi-Token Prediction (arxiv 2509.18362)</a></li></ul><hr>`,742)])])}const g=t(a,[["render",i]]);export{h as __pageData,g as default};
